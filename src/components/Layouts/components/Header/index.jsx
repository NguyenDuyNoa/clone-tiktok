...
const Header = () => {
    ...
    return (
        <header className=" h-16  w-[1150px] flex items-center justify-between">
            ...
            <Tippy
                ...
                render={attrs => (
                    <div className=" w-[361px]" tabIndex="-1" {...attrs}>
                        <Wrapper>
                            <h4 className=' px-[12px] py-[5px] cursor-pointer text-xs font-semibold text-text-gray'>Accounts</h4>
                            <AccountItem />
                            <AccountItem />
                            <AccountItem />
                        </Wrapper>
            ...
            >
                <div className="h-12 w-[361px] flex flex-row relative items-center bg-gray rounded-full pl-4 border-solid border-[1px] border-transparent focus-within:border-green-800">
                    <input
                        className="h-full flex-1 bg-transparent w-[300px] outline-none text-base caret-primary"
                        placeholder="Search"
                    />
                    <button className=" absolute right-16 text-span">
                        <FontAwesomeIcon icon={faCircleXmark} />
                    </button>
                    <button className=" absolute right-16 text-span">
                        <FontAwesomeIcon icon={faSpinner} />
                    </button>
                    <span className="w-[1px] bg-span h-7"></span>
                    <button className="pr-4 pl-3 h-full w-[52px] text-slate-400 hover:bg-hover rounded-r-full text-xl">
            ...
            <div className=" flex items-center">
                <Button leftIcon={<FontAwesomeIcon icon={faPlus} />}>Up load</Button>
